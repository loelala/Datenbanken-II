...
--------------------------------------------------------
DROP TABLE "DBST49"."KONTEN" cascade constraints;
DROP TABLE "DBST49"."KONTEN_LISTE_KUNDE_NT" cascade constraints;
DROP TABLE "DBST49"."KONTEN_LISTE_ZWEIGSTELLE_NT" cascade constraints;
DROP TABLE "DBST49"."KUNDE_V1" cascade constraints;
DROP TABLE "DBST49"."ZWEIGSTELLE_V1" cascade constraints;
DROP VIEW "DBST49"."DMRS_INSTALLATION";
DROP VIEW "DBST49"."DMRV_REPORTS_VERSION_1_0";
DROP TYPE "DBST49"."ADRESSET";
DROP TYPE "DBST49"."KONTENLISTET";
DROP TYPE "DBST49"."KONTOT";
DROP TYPE "DBST49"."KUNDET_V1";
DROP TYPE "DBST49"."ZWEIGSTELLET_V1";
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into DBST49.KONTEN (KONTO_ART,KONTO_NR,KONTO_STAND) values ('S','120768','234,56');
Insert into DBST49.KONTEN (KONTO_ART,KONTO_NR,KONTO_STAND) values ('G','678453','-456,78');
Insert into DBST49.KONTEN (KONTO_ART,KONTO_NR,KONTO_STAND) values ('G','348973','12567,56');
Insert into DBST49.KONTEN (KONTO_ART,KONTO_NR,KONTO_STAND) values ('G','987654','789,65');
Insert into DBST49.KONTEN (KONTO_ART,KONTO_NR,KONTO_STAND) values ('S','745363','-23,67');
