...
SET DEFINE OFF;
Insert into DBST49.KUNDE_V1 (KUNDE_V1_NR,KUNDE_V1_NAME,KUNDE_V1_STATUS,KUNDE_V1_ADRESSE,KUNDE_V1_KONTEN_LISTE) values ('2345','H. Fach','Geschäftskunde','DBST49.ADRESSET(''Münchnersrt.'',''33'',''Muenchen'',77777)',DBST49.KONTENLISTET(DBST49.KONTOT('S',120768,234.56),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',120768,234.56),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',120768,234.56),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',120768,234.56),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',120768,234.56),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',120768,234.56),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',120768,234.56),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',120768,234.56),DBST49.KONTOT('G',348973,12567.56)));
Insert into DBST49.KUNDE_V1 (KUNDE_V1_NR,KUNDE_V1_NAME,KUNDE_V1_STATUS,KUNDE_V1_ADRESSE,KUNDE_V1_KONTEN_LISTE) values ('7654','B. Meier','Privatkunde','DBST49.ADRESSET(''Eschenweg'',''12'',''Landshut'',66666)',DBST49.KONTENLISTET(DBST49.KONTOT('G',987654,789.65),DBST49.KONTOT('G',987654,789.65),DBST49.KONTOT('G',987654,789.65)));
Insert into DBST49.KUNDE_V1 (KUNDE_V1_NR,KUNDE_V1_NAME,KUNDE_V1_STATUS,KUNDE_V1_ADRESSE,KUNDE_V1_KONTEN_LISTE) values ('8764','J. Wiesner','Geschäftskunde','DBST49.ADRESSET(''Schellingstr.'',''42'',''Regensburg'',55555)',DBST49.KONTENLISTET(DBST49.KONTOT('G',678453,-456.78),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',745363,-23.67),DBST49.KONTOT('G',678453,-456.78),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',745363,-23.67),DBST49.KONTOT('G',678453,-456.78),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',745363,-23.67)));
REM INSERTING into DBST49.ZWEIGSTELLE_V1
SET DEFINE OFF;
Insert into DBST49.ZWEIGSTELLE_V1 (ZWEIGSTELLE_V1_NAME,ZWEIGSTELLE_V1_LEITER,ZWEIGSTELLE_V1_ADRESSE,ZWEIGSTELLE_V1_KONTEN_LISTE) values ('Bachdorf','1768','DBST49.ADRESSET(''Hochstr.'',''1'',''Bachdorf'',99999)',DBST49.KONTENLISTET(DBST49.KONTOT('S',120768,234.56),DBST49.KONTOT('G',678453,-456.78),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',120768,234.56),DBST49.KONTOT('G',678453,-456.78),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',120768,234.56),DBST49.KONTOT('G',678453,-456.78),DBST49.KONTOT('G',348973,12567.56),DBST49.KONTOT('S',120768,234.56),DBST49.KONTOT('G',678453,-456.78),DBST49.KONTOT('G',348973,12567.56)));
Insert into DBST49.ZWEIGSTELLE_V1 (ZWEIGSTELLE_V1_NAME,ZWEIGSTELLE_V1_LEITER,ZWEIGSTELLE_V1_ADRESSE,ZWEIGSTELLE_V1_KONTEN_LISTE) values ('Riedering','9823','DBST49.ADRESSET(''Simseestr.'',''3'',''Riedering'',88888)',DBST49.KONTENLISTET(DBST49.KONTOT('G',987654,789.65),DBST49.KONTOT('S',745363,-23.67),DBST49.KONTOT('G',987654,789.65),DBST49.KONTOT('S',745363,-23.67),DBST49.KONTOT('G',987654,789.65),DBST49.KONTOT('S',745363,-23.67),DBST49.KONTOT('G',987654,789.65),DBST49.KONTOT('S',745363,-23.67)));
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "DBST49"."ADRESSE" ADD UNIQUE ("SYS_NC_OID$")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
  TABLESPACE "USERS"  ENABLE;
